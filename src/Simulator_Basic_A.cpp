...
{   
    ...
    {   
        ...
        // If the selected house would make the resident happier than their current house, move.
...
double Simulator_Basic_A::calculateHappinessValueFor(Resident* res, int address) const
{
    unordered_set<const Resident*> adjacentNeighbors;
