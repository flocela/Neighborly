...
int XAxisL2RBottom::calcHorizontalLineLength()
{
    return _right_most_pixel_x__px - _left_most_pixel_x__px;
}

void XAxisL2RBottom::addHorizontalLine (std::vector<SDL_Rect>& rects)
{
    SDL_Rect rect;
...
void XAxisL2RBottom::addTicksAndLabels (
    std::vector<SDL_Rect>& rects, 
    std::vector<TextRect>& texts
)
{   
...
void XAxisL2RBottom::addTitle (std::vector<TextRect>& texts)
{
    TextRect tr = {
