#ifndef QUESTION_INT_2_H
#define QUESTION_INT_2_H
...
class Question_Int2: public Question
{
protected:
    Question_Int2 (const Question_Int2& obj) = default;
    Question_Int2 (Question_Int2&& obj) noexcept = default;
    Question_Int2& operator=(const Question_Int2& obj) = default;
    Question_Int2& operator=(Question_Int2&& obj) noexcept = default;

public:
    Question_Int2 () = delete;
    virtual ~Question_Int2() = default;
