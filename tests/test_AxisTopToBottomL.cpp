...
TEST_CASE("AxisTopToBottomL.getPixel()_OddTickThickness_OddPixelsPerUnit")
{
    AxisFormat format{};
...
TEST_CASE("AxisTopToBottomL.getPixel()_OddTickThickness_EvenPixelsPerUnit")
{
    AxisFormat format{};
    AxisTopToBottomL axis {
        format,
...
TEST_CASE("AxisTopToBottomL.getPixel()_EvenTickThickness_OddPixelsPerUnit")
{
    AxisFormat format{};
    AxisTopToBottomL axis {
        format,
...
TEST_CASE("AxisTopToBottomL.getPixel()_EvenTickThickness_EvenPixelsPerUnit")
{
    AxisFormat format{};
    AxisTopToBottomL axis {
        format,
