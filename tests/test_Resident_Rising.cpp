    ...
    " chooses blue_neutral neighbor")
{
    ...
    House& grHouse8 = h008;  // green_neutral resident lives in house 8
    House& blHouse16 = h016; // blue_neutral resident lives in house 16
    House& house11 = h011;   // next to blue_neutral resident
    House& house13 = h013;   // next to green_neutral resident
...
{   
    ...
    House& oldHouse = h000;  // resident's current house
    House& grHouse7 = h007;   // green_neutral resident lives in house 7
    House& grHouse8 = h008;   // green_neutral resident lives in house 8
    House& blHouse16 = h016;  // blue_neutral resident lives in house 16
    House& house2  = h002; // next to two green_neutral residents (happiness = 1.0)
    House& house11 = h011; // next to one green_neutral + one blue_neutral residents (happiness = 0.5)
    House& house12 = h012; // next to two green_neutral + one blue_neutral residents (happiness = 0.66)
